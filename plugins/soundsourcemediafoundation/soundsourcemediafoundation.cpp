...
SoundSourceMediaFoundation::SoundSourceMediaFoundation(QString filename)
        : Super(filename, "m4a"), m_pReader(NULL), m_pAudioType(NULL), m_wcFilename(
...
Mixxx::AudioSource::diff_type SoundSourceMediaFoundation::seekFrame(
...
Mixxx::AudioSource::size_type SoundSourceMediaFoundation::readFrameSamplesInterleaved(
 ...
 */
void SoundSourceMediaFoundation::copyFrames(sample_type *dest, size_t *destFrames,
