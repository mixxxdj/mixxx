...
IF /I "%PLATFORM%"=="arm64" (
    IF DEFINED BUILDENV_RELEASE (
        ...
        SET BUILDENV_NAME=mixxx-deps-2.6-arm64-windows-rel-37fb293
        SET BUILDENV_SHA256=15df1355a8180524c541645e47790fd1e5714dbb7e75efedca471f632d8255dd
    ) ELSE (
        SET BUILDENV_BRANCH=2.6
        SET VCPKG_TARGET_TRIPLET=arm64-windows
        SET BUILDENV_NAME=mixxx-deps-2.6-arm64-windows-2de72ad
        SET BUILDENV_SHA256=ca550a377b3af811c85b6a24da92dd21ec48c64754039ca62ac10f42e1e909a8
    )
) ELSE IF /I "%PLATFORM%"=="x64" (
    IF DEFINED BUILDENV_RELEASE (
        SET BUILDENV_BRANCH=2.6-rel
        SET VCPKG_TARGET_TRIPLET=x64-windows-release
        SET BUILDENV_NAME=mixxx-deps-2.6-x64-windows-rel-37fb293
        SET BUILDENV_SHA256=b01e01c611e72cc898a627a7f8264960c912b32801cb2f908e9f5c91f4c35697
    ) ELSE (
        SET BUILDENV_BRANCH=2.6
        SET VCPKG_TARGET_TRIPLET=x64-windows
        SET BUILDENV_NAME=mixxx-deps-2.6-x64-windows-2de72ad
        SET BUILDENV_SHA256=9adce79339359c15609acdfa2252e51a31c7e1d887c924765fa93d9e02edef81
    )
) ELSE (
