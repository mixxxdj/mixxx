...
IF DEFINED BUILDENV_RELEASE (
    ...
    SET BUILDENV_NAME=mixxx-deps-rel-2.4-x64-windows-37d19ef
    SET BUILDENV_SHA256=b4872736ed8c1bcc0973abe6dd942b1b0a583e127fa081ff872bf087d145036d
) ELSE (
    SET BUILDENV_BRANCH=2.4
    SET BUILDENV_NAME=mixxx-deps-2.4-x64-windows-5816327
    SET BUILDENV_SHA256=ad593b11fa4aecd0e2c1a0098812b3f860fe834c98fbbaf3c1b11acefea8adc4
)
