...
IF /I "%PLATFORM%"=="arm64" (
    IF DEFINED BUILDENV_RELEASE (
        ...
        SET BUILDENV_NAME=mixxx-deps-2.7-arm64-windows-rel-2a81b0d
        SET BUILDENV_SHA256=22b2833cbca9d1a5d1736a516f77c44f1813040f5962e7dc001114405f094739
    ) ELSE (
        SET BUILDENV_BRANCH=2.7
        SET VCPKG_TARGET_TRIPLET=arm64-windows
        SET BUILDENV_NAME=mixxx-deps-2.7-arm64-windows-36b8ec0
    ...
    IF DEFINED BUILDENV_RELEASE (
        ...
        SET BUILDENV_NAME=mixxx-deps-2.7-x64-windows-rel-2a81b0d
        SET BUILDENV_SHA256=71e240b0dd47f00e19d3955ada822a4242bdcb4f75fb0563cb83efe1f05485ca
    ) ELSE (
        SET BUILDENV_BRANCH=2.7
        SET VCPKG_TARGET_TRIPLET=x64-windows
        SET BUILDENV_NAME=mixxx-deps-2.7-x64-windows-36b8ec0
