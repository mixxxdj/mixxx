...
IF DEFINED BUILDENV_RELEASE (
    ...
    SET BUILDENV_NAME=mixxx-deps-rel-2.5-x64-windows-dea32d0
    SET BUILDENV_SHA256=23cb9232c7154273c0c1f6110ac64eb4b620bf37d8cdab1b37ae711b5e6ed8a7
) ELSE (
    SET BUILDENV_BRANCH=2.5
    SET BUILDENV_NAME=mixxx-deps-2.5-x64-windows-9d10a04
    SET BUILDENV_SHA256=483ff8469979d9828a45af4c0a5692eab4ab07b2b7d5c3d0f12a760ff6e532c3
)
