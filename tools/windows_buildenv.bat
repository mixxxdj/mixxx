...
IF DEFINED BUILDENV_RELEASE (
    ...
    vcpkg_update_main
    SET BUILDENV_NAME=mixxx-deps-2.6-x64-windows-rel-e249cbc
    SET BUILDENV_SHA256=68961b3b0d4e23f918f9d139903b6c5b5a758bdff350ce61109bea72384fb562
) ELSE (
    SET BUILDENV_BRANCH=2.6
    SET VCPKG_TARGET_TRIPLET=x64-windows
    SET BUILDENV_NAME=mixxx-deps-2.6-x64-windows-ee5f060
    SET BUILDENV_SHA256=d7e4e67362e1af04f8e7120c5f7fba6ce8b32a075f439f65e8122279f0021928
)
