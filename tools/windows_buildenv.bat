...
IF DEFINED BUILDENV_RELEASE (
    ...
    SET BUILDENV_NAME=mixxx-deps-2.4-x64-windows-release-e6808ff
    SET BUILDENV_SHA256=0ae48cbfff2080fa3c7c09e5cc542ecef95f9f094dcd179aa877c131ffdc067f
) ELSE (
    SET BUILDENV_BRANCH=2.4
    set VCPKG_TARGET_TRIPLET=x64-windows
    SET BUILDENV_NAME=mixxx-deps-2.4-x64-windows-432cdcd
    SET BUILDENV_SHA256=aed4341796725e564008c3428bb52bc502d104ab9b57634133447af5c3680ad6
)
