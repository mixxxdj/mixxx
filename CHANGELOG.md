...
* Fix detection of system hidapi library. The system hidapi library is linked if the version is >= 0.10.1; otherwise a vendored copy is used. [#4215](https://github.com/mixxxdj/mixxx/pull/4215)
