...
void DlgPreferences::createIcons()
{
    ...
    m_pSoundButton->setIcon(0, QIcon(":/images/preferences/soundhardware2.png"));
...
*/
    ...
    m_pMIDITreeItem->setIcon(0, QIcon(":/images/preferences/controllers2.png"));
...
*/
    ...
    m_pPlaylistButton->setIcon(0, QIcon(":/images/preferences/library2.png"));
    ...
    m_pControlsButton->setIcon(0, QIcon(":/images/preferences/interface2.png"));
    ...
    m_pEqButton->setIcon(0, QIcon(":/images/preferences/equalizers2.png"));
    ...
    m_pCrossfaderButton->setIcon(0, QIcon(":/images/preferences/crossfader2.png"));
    ...
    m_pRecordingButton->setIcon(0, QIcon(":/images/preferences/recording2.png"));
    ...
    m_pBPMdetectButton->setIcon(0, QIcon(":/images/preferences/bpmdetect2.png"));
    ...
    //instead...
    m_pVinylControlButton->setIcon(0, QIcon(":/images/preferences/vinyl2.png"));
    ...
    m_pShoutcastButton->setIcon(0, QIcon(":/images/preferences/broadcast2.png"));
    ...
    while (it.hasNext())
      {
        ...
        midiBindingsButton->setIcon(0, QIcon(":/images/preferences/controllers2.png"));
