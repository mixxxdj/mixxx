/***************************************************************************
                          visualdatasignal.cpp  -  description
                             -------------------
 ...
 * Default Constructor
 */
VisualDataSignal::VisualDataSignal(GLfloat *buffer, FastVertexArray *vertex) : VisualData(buffer, vertex)
{
};
 ...
 * Deconstructor.
 */
VisualDataSignal::~VisualDataSignal()
{
};
