/**
* @file midicontroller-preset.cpp
* @author Sean Pappalardo spappalardo@mixxx.org
* @date Sat 7 Apr 2012
* @brief MIDI Controller class' XML preset handling functions, separated for clarity
*
*/
...
QDomDocument MidiController::buildXML() {

    // The XML header and script stuff is handled by the superclass
    QDomDocument doc = Controller::buildXML();
