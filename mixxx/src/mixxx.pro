...
unix {
	...
	unix:!macx:LIBS += `pkg-config --libs portaudio-2.0` -lasound -ljack -lrt
...
win32 {
  ...
  contains(VISUALSTUDIO, 1) {
    QMAKE_CXXFLAGS += -GX
    QMAKE_LFLAGS += /VERBOSE:LIB /LIBPATH:$$WINLIBPATH /NODEFAULTLIB:library /NODEFAULTLIB:libcd /NODEFAULTLIB:libcmt /NODEFAULTLIB:libc /NODEFAULTLIB:libcmtd
  }
  contains(VISUALSTUDIO, 0) {
...
contains(CONFIG, qt3support) {
	FORMS3	= dlgprefsounddlg.ui dlgprefmididlg.ui dlgprefbpmdlg.ui dlgbpmtapdlg.ui dlgprefplaylistdlg.ui dlgprefcontrolsdlg.ui dlgprefmixerdlg.ui dlgprefrecorddlg.ui
}
contains(CONFIG, qt3) {
	FORMS	= dlgprefsounddlg.ui dlgprefmididlg.ui dlgprefbpmdlg.ui dlgbpmtapdlg.ui dlgprefplaylistdlg.ui dlgprefcontrolsdlg.ui dlgprefmixerdlg.ui dlgprefrecorddlg.ui
}

SOURCES += enginebuffercue.cpp input.cpp mixxxmenuplaylists.cpp trackplaylistlist.cpp mixxxkeyboard.cpp configobject.cpp controlobjectthread.cpp controlobjectthreadwidget.cpp controlobjectthreadmain.cpp controlevent.cpp controllogpotmeter.cpp controlobject.cpp controlnull.cpp controlpotmeter.cpp controlpushbutton.cpp controlttrotary.cpp controlbeat.cpp dlgpreferences.cpp dlgprefbpm.cpp dlgbpmtap.cpp dlgprefsound.cpp dlgprefmidi.cpp dlgprefplaylist.cpp dlgprefcontrols.cpp dlgprefmixer.cpp dlgprefrecord.cpp enginebuffer.cpp enginebufferscale.cpp engineclipping.cpp enginefilterblock.cpp enginefilteriir.cpp engineobject.cpp enginepregain.cpp enginevolume.cpp main.cpp midiobject.cpp midiobjectnull.cpp mixxx.cpp mixxxview.cpp player.cpp playerproxy.cpp soundsource.cpp soundsourcemp3.cpp soundsourceoggvorbis.cpp enginechannel.cpp enginemaster.cpp wwidget.cpp wpixmapstore.cpp wlabel.cpp wnumber.cpp wnumberpos.cpp wnumberrate.cpp wnumberbpm.cpp wknob.cpp wdisplay.cpp wvumeter.cpp wpushbutton.cpp wslidercomposed.cpp wslider.cpp wtracktable.cpp wtracktableitem.cpp enginedelay.cpp engineflanger.cpp enginespectralfwd.cpp mathstuff.cpp readerextract.cpp readerextractwave.cpp readerevent.cpp rtthread.cpp  windowkaiser.cpp probabilityvector.cpp reader.cpp trackinfoobject.cpp enginevumeter.cpp peaklist.cpp rotary.cpp log.cpp wstatuslight.cpp enginefilter.cpp
HEADERS += enginebuffercue.h input.h mixxxmenuplaylists.h trackplaylistlist.h mixxxkeyboard.h configobject.h controlobjectthread.h controlobjectthreadwidget.h controlobjectthreadmain.h controlevent.h controllogpotmeter.h controlobject.h controlnull.h controlpotmeter.h controlpushbutton.h controlttrotary.h controlbeat.h defs.h dlgprefrecord.h dlgpreferences.h dlgprefbpm.h dlgbpmtap.h dlgprefsound.h dlgprefmidi.h dlgprefplaylist.h dlgprefcontrols.h dlgprefmixer.h enginebuffer.h enginebufferscale.h engineclipping.h enginefilterblock.h enginefilteriir.h engineobject.h enginepregain.h enginevolume.h midiobject.h midiobjectnull.h mixxx.h mixxxview.h player.h playerproxy.h soundsource.h soundsourcemp3.h soundsourceoggvorbis.h enginechannel.h enginemaster.h wwidget.h wpixmapstore.h wlabel.h wnumber.h wnumberpos.h wnumberrate.h wnumberbpm.h wknob.h wdisplay.h wvumeter.h wpushbutton.h wslidercomposed.h wslider.h wtracktable.h wtracktableitem.h enginedelay.h engineflanger.h enginespectralfwd.h mathstuff.h readerextract.h readerextractwave.h  readerevent.h rtthread.h windowkaiser.h probabilityvector.h reader.h trackinfoobject.h enginevumeter.h peaklist.h rotary.h log.h wstatuslight.h enginefilter.h

SOURCES += midiledhandler.cpp
HEADERS += midiledhandler.h
