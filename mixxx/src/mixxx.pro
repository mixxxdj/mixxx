...
FORMS	= dlgprefsounddlg.ui dlgprefmididlg.ui dlgprefplaylistdlg.ui dlgprefcontrolsdlg.ui dlgmousecalibration.ui
...
# Mouse
SOURCES += rotary.cpp mouse.cpp mouselinux.cpp
HEADERS += rotary.h mouse.h mouselinux.h
