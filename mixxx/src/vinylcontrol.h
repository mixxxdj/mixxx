...
class VinylControl : public QThread
{
    public:
        ...
        virtual float getSignalLeft();
        virtual float getSignalRight();
    ...
    protected:
        ...
        float m_fSignalLeft;            //Measures the left channel's volume.
        float m_fSignalRight;           //Measures the right channel's volume.
