...
void TDStretch::setSeekWindowTweak(int newTweak)
{
	seekWindowTweakMs = newTweak;
...
void TDStretch::calcSeqParameters()
{
    ...
    /*#define AUTOSEQ_TEMPO_LOW   0.85     // auto setting low tempo range
    #define AUTOSEQ_TEMPO_TOP   1.07     // auto setting top tempo range

    // sequence-ms setting values at above low & top tempo
    #define AUTOSEQ_AT_MIN      160.0
    #define AUTOSEQ_AT_MAX      45.0
    #define AUTOSEQ_K           ((AUTOSEQ_AT_MAX - AUTOSEQ_AT_MIN) / (AUTOSEQ_TEMPO_TOP - AUTOSEQ_TEMPO_LOW))
    #define AUTOSEQ_C           (AUTOSEQ_AT_MIN - (AUTOSEQ_K) * (AUTOSEQ_TEMPO_LOW))

    // seek-window-ms setting values at above low & top tempo
    #define AUTOSEEK_AT_MIN     30.0
    #define AUTOSEEK_AT_MAX     5.0
    ...
    if (bAutoSeqSetting)
    {
        seq = AUTOSEQ_C + AUTOSEQ_K * tempo + seekWindowTweakMs;
    ...
    if (bAutoSeekSetting)
    {
        seek = AUTOSEEK_C + AUTOSEEK_K * tempo + (seekWindowTweakMs / 2);
    ...
    //printf("tweak val: %i window: %i length: %i\n", seekWindowTweakMs, seekWindowMs, sequenceMs);
}
