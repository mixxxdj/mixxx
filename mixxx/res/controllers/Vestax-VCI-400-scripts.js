...
VestaxVCI400.Decks.C.addButton("HOT_CUE1", new VestaxVCI400.Button(0x94,0x0b), "onHotCue1Activate");
VestaxVCI400.Decks.C.addButton("HOT_CUE2", new VestaxVCI400.Button(0x94,0x0c), "onHotCue2Activate");
VestaxVCI400.Decks.C.addButton("HOT_CUE3", new VestaxVCI400.Button(0x94,0x0d), "onHotCue3Activate");
VestaxVCI400.Decks.C.addButton("HOT_CUE4", new VestaxVCI400.Button(0x94,0x0e), "onHotCue4Activate");

VestaxVCI400.Decks.D.addButton("HOT_CUE1", new VestaxVCI400.Button(0x95,0x0b), "onHotCue1Activate");
VestaxVCI400.Decks.D.addButton("HOT_CUE2", new VestaxVCI400.Button(0x95,0x0c), "onHotCue2Activate");
VestaxVCI400.Decks.D.addButton("HOT_CUE3", new VestaxVCI400.Button(0x95,0x0d), "onHotCue3Activate");
VestaxVCI400.Decks.D.addButton("HOT_CUE4", new VestaxVCI400.Button(0x95,0x0e), "onHotCue4Activate");
...
VestaxVCI400.Decks.C.addButton("LOOP_IN", new VestaxVCI400.Button(0x94,0x9), "onLoopIn");
VestaxVCI400.Decks.D.addButton("LOOP_IN", new VestaxVCI400.Button(0x95,0x9), "onLoopIn");
...
VestaxVCI400.Decks.C.addButton("LOOP_OUT", new VestaxVCI400.Button(0x94,0xA), "onLoopOut");
VestaxVCI400.Decks.D.addButton("LOOP_OUT", new VestaxVCI400.Button(0x95,0xA), "onLoopOut");
...
VestaxVCI400.Decks.C.addButton("BEAT_LOOP", new VestaxVCI400.Button(0x94,0x14), "onBeatLoop");
VestaxVCI400.Decks.D.addButton("BEAT_LOOP", new VestaxVCI400.Button(0x95,0x14), "onBeatLoop");
