...
EngineFilter::EngineFilter(char *conf, int predefinedType)
        : iir(0), fir(0), tmp(0), ff(NULL), funcp(NULL), run(NULL) {
...
double processSampleBp(void *bufIn, const double sample) {
    ...
    iir -= 0.8716357571117795 * tmp;
    fir = tmp;
    iir -= -1.704721971813985 * buf[0];
    fir += -buf[0] - buf[0];
    fir += iir;
    tmp = buf[1];
    buf[1] = iir;
    val = fir;
    iir = val;
    iir -= 0.9881828644977958 * tmp;
    fir = tmp;
    iir -= -1.986910175866046 * buf[2];
    fir += -buf[2] - buf[2];
    fir += iir;
    tmp = buf[3];
    buf[3] = iir;
    val = fir;
    iir = val;
    iir -= 0.6739219969192579 * tmp;
    fir = tmp;
    iir -= -1.534687501075499 * buf[4];
    fir += -buf[4] - buf[4];
    fir += iir;
    tmp = buf[5];
    buf[5] = iir;
    val = fir;
    iir = val;
    iir -= 0.9644444065027918 * tmp;
    fir = tmp;
    iir -= -1.963091971649609 * buf[6];
    fir += -buf[6] - buf[6];
    fir += iir;
    tmp = buf[7];
    buf[7] = iir;
    val = fir;
    iir = val;
    iir -= 0.5508744524070673 * tmp;
    fir = tmp;
    iir -= -1.437951258090782 * buf[8];
    fir += buf[8] + buf[8];
    fir += iir;
    tmp = buf[9];
    buf[9] = iir;
    val = fir;
    iir = val;
    iir -= 0.940359918647641 * tmp;
    fir = tmp;
    iir -= -1.938825711089784 * buf[10];
    fir += buf[10] + buf[10];
    fir += iir;
    tmp = buf[11];
    buf[11] = iir;
    val = fir;
    iir = val;
    iir -= 0.494560064204263 * tmp;
    fir = tmp;
    iir -= -1.400685123336887 * buf[12];
    fir += buf[12] + buf[12];
    fir += iir;
    tmp = buf[13];
    buf[13] = iir;
    val = fir;
    iir = val;
    iir -= 0.9201106143536053 * tmp;
    fir = tmp;
    iir -= -1.918341654664469 * buf[14];
    fir += buf[14] + buf[14];
    fir += iir;
    buf[15] = iir;
    val = fir;
...
double processSampleHp(void *bufIn, const double sample) {
    ...
    iir -= 0.8503595356078639 * tmp;
    fir = tmp;
    iir -= -1.683892145680763 * buf[0];
    fir += -buf[0] - buf[0];
    fir += iir;
    tmp = buf[1];
    buf[1] = iir;
    val = fir;
    iir = val;
    iir -= 0.6256182051727028 * tmp;
    fir = tmp;
    iir -= -1.479369644054996 * buf[2];
    fir += -buf[2] - buf[2];
    fir += iir;
    tmp = buf[3];
    buf[3] = iir;
    val = fir;
    iir = val;
    iir -= 0.4873536896159359 * tmp;
    fir = tmp;
    iir -= -1.35354408027022 * buf[4];
    fir += -buf[4] - buf[4];
    fir += iir;
    tmp = buf[5];
    buf[5] = iir;
    val = fir;
    iir = val;
    iir -= 0.4219026276867782 * tmp;
    fir = tmp;
    iir -= -1.2939813158517 * buf[6];
    fir += -buf[6] - buf[6];
    fir += iir;
    buf[7] = iir;
    val = fir;
...
double processSampleLp(void *bufIn, const double sample) {
    ...
    iir -= 0.9862009760667707 * tmp;
    fir = tmp;
    iir -= -1.984941152135637 * buf[0];
    fir += buf[0] + buf[0];
    fir += iir;
    tmp = buf[1];
    buf[1] = iir;
    val = fir;
    iir = val;
    iir -= 0.9611983723246083 * tmp;
    fir = tmp;
    iir -= -1.95995440725112 * buf[2];
    fir += buf[2] + buf[2];
    fir += iir;
    tmp = buf[3];
    buf[3] = iir;
    val = fir;
    iir = val;
    iir -= 0.9424834072512262 * tmp;
    fir = tmp;
    iir -= -1.941251312860088 * buf[4];
    fir += buf[4] + buf[4];
    fir += iir;
    tmp = buf[5];
    buf[5] = iir;
    val = fir;
    iir = val;
    iir -= 0.9325031355986387 * tmp;
    fir = tmp;
    iir -= -1.93127737157649 * buf[6];
    fir += buf[6] + buf[6];
    fir += iir;
    buf[7] = iir;
    val = fir;
