...
//RateControl::RateControl(EngineChannel* pChannel)
//        : m_pChannel(pChannel),
...
//}
//
//EngineChannel* RateControl::getChannel() {
//    return m_pChannel;
//}
//
//double RateControl::getFileBpm() const {
