...
void CueControl::hotcueSet(HotcueControl* pControl, double value, HotcueSetMode mode) {
    ...
    case HotcueSetMode::Loop: {
        if (loopEnabled) {
            ...
            // TODO: Remove this conversion and use mixxx::FramePos throughout the code base
            cueEndPosition = framePosToSamplePos(pBeats->findNBeatsFromFrame(
                    samplePosToFramePos(cueStartPosition), beatloopSize));
        }
