...
void HotcueControl::slotHotcueColorChanged(double newColorId) {
    m_pCue->setColor(Color::kDefaultPredefinedColorsSet.predefinedColorFromId(newColorId));
...
PredefinedColorPointer HotcueControl::getColor() const {
    return Color::kDefaultPredefinedColorsSet.predefinedColorFromId(m_hotcueColor->get());
}
