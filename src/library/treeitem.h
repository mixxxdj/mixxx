...
class TreeItem final {
  ...
  public:
    ...
    int childRow(const TreeItem* pChild) {
        return m_children.indexOf(pChild, 0);
    }
  ...
  private:
    ...
    // insertChildren() -> initFeatureRecursively() and is just a shortcut
    //  to the library feature of the root item!
