...
void ColumnCache::setColumns(const QStringList& columns) {
    ...
    insertColumnNameByEnum(COLUMN_LIBRARYTABLE_MATCH, LIBRARYTABLE_MATCH);
    insertColumnNameByEnum(COLUMN_LIBRARYTABLE_PLAYCOUNT, LIBRARYTABLE_PLAYCOUNT);
    ...
    insertColumnSortByEnum(COLUMN_LIBRARYTABLE_MATCH, kSortInt);
    insertColumnSortByEnum(COLUMN_LIBRARYTABLE_PLAYCOUNT, kSortInt);
