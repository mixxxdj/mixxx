...
void ColumnCache::setColumns(const QStringList& columns) {
    ...
    const QString sortDefault("%1");
    m_columnSortByIndex.clear();
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_ID], sortDefault);
    ...
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_DURATION], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_BITRATE], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_BPM], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_REPLAYGAIN], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_CUEPOINT], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_URL], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_SAMPLERATE], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_WAVESUMMARYHEX], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_CHANNELS], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_MIXXXDELETED], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_DATETIMEADDED], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_HEADERPARSED], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_TIMESPLAYED], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_PLAYED], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_RATING], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_KEY], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_KEY_ID], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_BPM_LOCK], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_PREVIEW], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_COVERART], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_COVERART_SOURCE], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_COVERART_TYPE], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_COVERART_LOCATION], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_LIBRARYTABLE_COVERART_HASH], sortDefault);

    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_TRACKLOCATIONSTABLE_FSDELETED], sortDefault);

    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_PLAYLISTTRACKSTABLE_TRACKID], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_PLAYLISTTRACKSTABLE_POSITION], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_PLAYLISTTRACKSTABLE_PLAYLISTID], sortDefault);
    ...
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_PLAYLISTTRACKSTABLE_DATETIMEADDED], sortDefault);

    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_CRATETRACKSTABLE_TRACKID], sortDefault);
    m_columnSortByIndex.insert(m_columnIndexByEnum[COLUMN_CRATETRACKSTABLE_CRATEID], sortDefault);
