...
#include "moc_dlggroupedsmartiesinfo.cpp"

// const bool sDebug = false;

dlgGroupedSmartiesInfo::dlgGroupedSmartiesInfo(
...
//          m_isUpdatingUI(false),
{
    ...
    //    connect(m_feature, &GroupedSmartiesFeature::setBlockerOff, this,
    //    &dlgGroupedSmartiesInfo::onSetBlockerOff);
    connect(m_feature,
            &GroupedSmartiesFeature::updateSmartiesData,
            this,
            &dlgGroupedSmartiesInfo::onUpdateSmartiesData);

    // Initialize the lock-button states on UI load
    connect(buttonLock, &QPushButton::clicked, this, &dlgGroupedSmartiesInfo::toggleLockStatus);
...
void dlgGroupedSmartiesInfo::init(const QVariantList& smartiesData,
...
void dlgGroupedSmartiesInfo::connectConditions() {
    for (int i = 1; i <= 12; ++i) {
        ...
        if (fieldComboBox && operatorComboBox && valueLineEdit &&
            ...
            connect(fieldComboBox,
                    ...
                    this,
                    &dlgGroupedSmartiesInfo::updateConditionState);
...
void dlgGroupedSmartiesInfo::setupConditionUI() {
    for (int i = 1; i <= 12; ++i) {
        auto* fieldComboBox = findChild<QComboBox*>(
                QStringLiteral("comboBoxCondition%1Field").arg(i));
        auto* operatorComboBox = findChild<QComboBox*>(
        ...
        if (fieldComboBox) {
            connect(fieldComboBox,
                    ...
                    this,
                    &dlgGroupedSmartiesInfo::onFieldComboBoxChanged);
        }
        if (operatorComboBox) {
            connect(operatorComboBox,
                    QOverload<int>::of(&QComboBox::currentIndexChanged),
                    this,
                    &dlgGroupedSmartiesInfo::onOperatorComboBoxChanged);
        }
        if (valueComboBox) {
            connect(valueComboBox,
                    QOverload<int>::of(&QComboBox::currentIndexChanged),
                    this,
                    &dlgGroupedSmartiesInfo::onValueComboBoxChanged);
        }
...
void dlgGroupedSmartiesInfo::initHeaderTable(const QVariantList& smartiesData) {
    if (sDebug) {
...
void dlgGroupedSmartiesInfo::initConditionsTable(const QVariantList& smartiesData) {
...
void dlgGroupedSmartiesInfo::initPlaylistCrateTable(const QVariantList& playlistsCratesData) {
    if (sDebug) {
...
void dlgGroupedSmartiesInfo::onSetBlockerOff(const QString& blocker) {
    if (blocker == "previous") {
...
void dlgGroupedSmartiesInfo::onUpdateSmartiesData(const QVariantList& smartiesData) {
...
QVariant dlgGroupedSmartiesInfo::getUpdatedData() const {
    // Collect and return the updated data
    return collectUIChanges();
}

void dlgGroupedSmartiesInfo::populateUI() {
    ...
    connect(applyButton,
            &QPushButton::clicked,
            this,
            &dlgGroupedSmartiesInfo::onApplyButtonClicked);
    connect(newButton, &QPushButton::clicked, this, &dlgGroupedSmartiesInfo::onNewButtonClicked);
    connect(deleteButton,
            &QPushButton::clicked,
            this,
            &dlgGroupedSmartiesInfo::onDeleteButtonClicked);
    connect(previousButton,
            &QPushButton::clicked,
            this,
            &dlgGroupedSmartiesInfo::onPreviousButtonClicked);
    connect(nextButton, &QPushButton::clicked, this, &dlgGroupedSmartiesInfo::onNextButtonClicked);
    connect(okButton, &QPushButton::clicked, this, &dlgGroupedSmartiesInfo::onOKButtonClicked);
    connect(cancelButton,
            &QPushButton::clicked,
            this,
            &dlgGroupedSmartiesInfo::onCancelButtonClicked);
    // set
    m_isUpdatingUI = false;
    if (sDebug) {
...
void dlgGroupedSmartiesInfo::onFieldComboBoxChanged() {
...
// narrow possible operator selections based on field selection
void dlgGroupedSmartiesInfo::onOperatorComboBoxChanged() {
    QStringList stringFieldOptions = {"artist",
            "title",
            "album",
            "album_artist",
...
void dlgGroupedSmartiesInfo::onValueComboBoxChanged() {
...
void dlgGroupedSmartiesInfo::storeUIIn2Table() {
...
// validatity check
bool dlgGroupedSmartiesInfo::validationCheck() {
    storeUIIn2Table();
    // textEditValidation->setText(QStringLiteral(""));
...
void dlgGroupedSmartiesInfo::toggleLockStatus() {
...
QVariantList dlgGroupedSmartiesInfo::collectUIChanges() const {
    if (sDebug) {
...
void dlgGroupedSmartiesInfo::onApplyButtonClicked() {
    textEditValidation->setText(QStringLiteral(" "));
    if (sDebug) {
...
void dlgGroupedSmartiesInfo::onNewButtonClicked() {
...
void dlgGroupedSmartiesInfo::onDeleteButtonClicked() {
    if (!m_isUpdatingUI) { // Only emit if not in update mode
        if (sDebug) {
...
void dlgGroupedSmartiesInfo::onPreviousButtonClicked() {
    if (!m_isUpdatingUI) { // Only emit if not in update mode
        if (sDebug) {
...
void dlgGroupedSmartiesInfo::onNextButtonClicked() {
    if (!m_isUpdatingUI) { // Only emit if not in update mode
        if (sDebug) {
...
void dlgGroupedSmartiesInfo::onOKButtonClicked() {
    if (sDebug) {
...
void dlgGroupedSmartiesInfo::onCancelButtonClicked() {
    if (sDebug) {
...
void dlgGroupedSmartiesInfo::updateConditionState() {
    if (sDebug) {
...
void dlgGroupedSmartiesInfo::insertCondition(int index) {
    if (sDebug) {
...
void dlgGroupedSmartiesInfo::removeCondition(int index) {
    if (sDebug) {
...
void dlgGroupedSmartiesInfo::swapConditionWithAbove(int index) {
    if (sDebug) {
...
void dlgGroupedSmartiesInfo::swapConditionWithBelow(int index) {
    if (sDebug) {
...
void dlgGroupedSmartiesInfo::copyCondition(int fromIndex, int toIndex) {
    if (sDebug) {
...
void dlgGroupedSmartiesInfo::clearCondition(int index) {
    if (sDebug) {
...
void dlgGroupedSmartiesInfo::swapConditions(int index1, int index2) {
    if (sDebug) {
...
QString dlgGroupedSmartiesInfo::buildWhereClause() {
    if (sDebug) {
