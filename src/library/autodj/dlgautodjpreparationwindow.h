...
#include "library/autodj/ui_dlgautodjpreparationwindow.h"
...
class DlgAutoDJPreparationWindow : public QWidget,
                                   public Ui::DlgAutoDJPreparationWindow,
                                   public LibraryView {
    Q_OBJECT
  public:
    DlgAutoDJPreparationWindow(WLibraryPreparationWindow* parent,
            UserSettingsPointer pConfig,
            Library* pLibrary,
            AutoDJProcessor* pProcessor,
            KeyboardEventFilter* pKeyboard);
    ~DlgAutoDJPreparationWindow() override;
  ...
  private:
    void setupActionButton(QPushButton* pButton,
            void (DlgAutoDJPreparationWindow::*pSlot)(bool),
    ...
    // WLibraryPreparationWindowTrackTableView* const m_pTrackTableView;
