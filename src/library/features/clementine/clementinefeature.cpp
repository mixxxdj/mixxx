...
#include "library/features/clementine/clementineplaylistmodel.h"
...
ClementineFeature::ClementineFeature(UserSettingsPointer pConfig,
                               Library* pLibrary,
                               QObject* parent,
...
QString ClementineFeature::getIconPath() {
    return ":/images/library/ic_library_clementine.png";
}
...
QPointer<TreeItemModel> ClementineFeature::getChildModel() {
    return &m_childModel;
}
