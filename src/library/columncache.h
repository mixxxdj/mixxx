...
class ColumnCache : public QObject {
  ...
  public:
    enum Column {
        ...
        COLUMN_LIBRARYTABLE_CMRT,
        COLUMN_LIBRARYTABLE_CMRT_CANONICAL,
        COLUMN_LIBRARYTABLE_CMRT_OFFSET,
        COLUMN_LIBRARYTABLE_CMRT_CANONICAL_ARTIST,
        COLUMN_LIBRARYTABLE_CMRT_CANONICAL_TITLE,
        COLUMN_LIBRARYTABLE_CMRT_GROUP_ID,
        COLUMN_LIBRARYTABLE_CMRT_MATCH_SCORE,
        COLUMN_LIBRARYTABLE_CMRT_QUALITY_SCORE,
        COLUMN_LIBRARYTABLE_CMRT_USE_DATA,
        COLUMN_LIBRARYTABLE_CMRT_HAS_GROUP,
