...
QString calcFingerprint(const Mixxx::AudioSourcePointer& pAudioSource) {
    ...
    DEBUG_ASSERT(2 ==
                 kFingerprintChannels);  // implicit assumption of the next line
    ...
    SampleUtil::convertFloat32ToS16(&fingerprintSamples[0], sampleBuffer.data(),
    ...
    if (ret == 1) {
        ...
        chromaprint_encode_fingerprint(fprint, size,
                                       CHROMAPRINT_ALGORITHM_DEFAULT, &encoded,
                                       &encoded_size, 1);
...
ChromaPrinter::ChromaPrinter(QObject* parent) : QObject(parent) {
}
