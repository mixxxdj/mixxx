...
QVariant TrackSearchListModel::data(
    ...
    case GenresRole: {
        const auto genreTags = rowItem.customTags.getFacetedTagsOrdered(
    ...
    case GenreTagsRole:
        return QVariant::fromValue(rowItem.customTags.getFacetedTagsOrdered(
                mixxx::CustomTags::kFacetGenre));
    case MoodsRole: {
        const auto moodTags = rowItem.customTags.getFacetedTagsOrdered(
    ...
    case MoodTagsRole:
        return QVariant::fromValue(rowItem.customTags.getFacetedTagsOrdered(
                mixxx::CustomTags::kFacetMood));
    case CommentRole:
        return rowItem.customTags.getFacetedTagLabel(
