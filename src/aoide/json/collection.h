...
constexpr int kMediaSourcePathKindUri = 0;
constexpr int kMediaSourcePathKindUrl = 1;
constexpr int kMediaSourcePathKindFileUrl = 2;
constexpr int kMediaSourcePathKindVirtualFilePath = 3;

class MediaSourceConfig : public Object {
  public:
    static MediaSourceConfig forLocalFiles(
            const std::optional<mixxx::EncodedUrl>& baseUrl = std::nullopt);
    ...
    std::optional<mixxx::EncodedUrl> baseUrl() const;
    void setBaseUrl(
            const std::optional<mixxx::EncodedUrl>& baseUrl = std::nullopt);
