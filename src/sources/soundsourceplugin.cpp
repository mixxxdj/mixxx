...
char** SoundSourcePlugin::allocFileExtensions(const QList<QString>& supportedFileExtensions) {
    //Convert to C string array.
    char** fileExtensions = (char**)malloc((supportedFileExtensions.count() + 1) * sizeof(char*));
