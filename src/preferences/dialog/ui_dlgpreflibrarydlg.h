...
class Ui_DlgPrefLibraryDlg {
  public:
    ...
    void setupUi(QWidget* DlgPrefLibraryDlg) {
        ...
        label_doubeClickAction->setAlignment(Qt::AlignLeft | Qt::AlignVCenter);
        ...
        label_rowHeight->setAlignment(Qt::AlignLeft | Qt::AlignVCenter);
        ...
        label_libraryFont->setAlignment(Qt::AlignLeft | Qt::AlignVCenter);
        ...
        label_bpm_precision->setAlignment(Qt::AlignLeft | Qt::AlignVCenter);
        ...
        label_searchDebouncingTimeout->setAlignment(Qt::AlignLeft | Qt::AlignVCenter);
        ...
        label_searchBpmFuzzyRange->setAlignment(Qt::AlignLeft | Qt::AlignVCenter);
        ...
        label_history_track_duplicate_distance->setAlignment(Qt::AlignLeft | Qt::AlignVCenter);
        ...
        label_history_cleanup->setAlignment(Qt::AlignLeft | Qt::AlignVCenter);
        ...
        QWidget::setTabOrder(checkBox_serato_metadata_export, checkBox_use_relative_path);
        QWidget::setTabOrder(checkBox_use_relative_path, checkBox_edit_metadata_selected_clicked);
        ...
        QWidget::setTabOrder(radioButton_dbclick_ignore, spinBox_row_height);
        QWidget::setTabOrder(spinBox_row_height, btn_library_font);
        QWidget::setTabOrder(btn_library_font, spinbox_bpm_precision);
        QWidget::setTabOrder(spinbox_bpm_precision, checkbox_played_track_color);
        QWidget::setTabOrder(checkbox_played_track_color, spinBox_search_debouncing_timeout);
        ...
        QWidget::setTabOrder(comboBox_search_bpm_fuzzy_range,
                spinbox_history_track_duplicate_distance);
        QWidget::setTabOrder(spinbox_history_track_duplicate_distance,
                spinbox_history_min_tracks_to_keep);
        QWidget::setTabOrder(spinbox_history_min_tracks_to_keep, checkBox_show_rhythmbox);
