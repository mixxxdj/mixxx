...
DlgAbout::DlgAbout(QWidget* parent) : QDialog(parent), Ui::DlgAboutDlg() {
    ...
    thisReleaseContributors << "Alex Barker"
                            << "Matthew Mikolay"
                            << "Thanasis Liappis"
                            << "Daniel Lindenfelser"
                            << "Andrey Smelov"
    ...
    pastDevelopers << "Tue Haste Andersen"
                   << "Ken Haste Andersen"
                   << "Cedric Gestes"
                   << "John Sully"
                   << "Torben Hohn"
    ...
    pastContributors << "Ludek Hor&#225;cek"
                     << "Svein Magne Bang"
                     << "Kristoffer Jensen"
                     << "Ingo Kossyk"
                     << "Mads Holm"
    ...
    sections << sectionTemplate.arg(s_devTeam,
             ...
             << sectionTemplate.arg(s_pastDevs, pastDevelopers.join("<br>"))
