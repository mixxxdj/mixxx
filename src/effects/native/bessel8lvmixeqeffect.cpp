...
EffectManifest Bessel8LVMixEQEffect::getManifest() {
    ...
    manifest.setDescription(QObject::tr(
            "A Bessel 8th order filter equalizer with Lipshitz and Vanderkooy "
            "mix (bit perfect unity, roll-off -48 db/Oct). "
...
void Bessel8LVMixEQEffect::processChannel(
        const ChannelHandle& handle, Bessel8LVMixEQEffectGroupState* pState,
