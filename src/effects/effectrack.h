...
//typedef EffectRack* EffectRackPointer;
//typedef StandardEffectRack* StandardEffectRackPointer;
//typedef EqualizerRack* EqualizerRackPointer;
//typedef QuickEffectRack* QuickEffectRackPointer;
