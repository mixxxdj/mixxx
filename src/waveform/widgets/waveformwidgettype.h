...
class WaveformWidgetType {
  public:
    enum Type {
        ...
        QOpenGLRGBWaveform,      // 17 RGB (all-shaders)
        QOpenGLLRRGBWaveform,    // 18 L/R RGB (all-shaders)
        QOpenGLFilteredWaveform, // 19 Filtered (all-shaders)
        QOpenGLSimpleWaveform,   // 20 Simple (all-shaders)
#endif
