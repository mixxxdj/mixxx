...
void WaveformWidgetRenderer::onPreRender(const PerformanceTimer& frameTimer, int waitToSwapMicros) {
    ...
    double truePlayPos = m_visualPlayPosition->getAtNextVSync(frameTimer, waitToSwapMicros);
