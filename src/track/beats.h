...
class Beats final : public QObject {
    Q_OBJECT
  public:
    /// iSampleRate may be provided if a more accurate sample rate is known
    /// than the one associated with the Track.
    explicit Beats(const Track* track, SINT iSampleRate = 0);
    /// iSampleRate may be provided if a more accurate sample rate is known
    /// than the one associated with the Track. If it is zero then the track's
