...
TEST_F(QmlWaveformOverviewTest, RendersAvailableSummaryWithoutAnalyzerProgress) {
    ...
    EXPECT_EQ(0, paintedPixelCount(empty));
    ...
    ASSERT_GT(paintedPixelCount(partial), 0);
    ...
    ASSERT_GT(paintedPixelCount(complete), 0);
    ...
    ASSERT_GT(paintedPixelCount(filtered), 0);
