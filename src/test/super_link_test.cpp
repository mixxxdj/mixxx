...
TEST_F(SuperLinkTest, LinkDefault) {
    ...
    m_pEffectSlot->onEffectMetaParameterChanged(1.0);
    EXPECT_EQ(1.0, m_pControlValue->get());
    m_pEffectSlot->onEffectMetaParameterChanged(0.5);
    EXPECT_EQ(1.0, m_pControlValue->get());
    m_pEffectSlot->onEffectMetaParameterChanged(0.3);
    EXPECT_EQ(1.0, m_pControlValue->get());
}
...
TEST_F(SuperLinkTest, LinkLinkedInverse) {
    ...
    m_pEffectSlot->onEffectMetaParameterChanged(0.0);
    EXPECT_EQ(1.0, m_pControlValue->get());
    m_pEffectSlot->onEffectMetaParameterChanged(0.5);
    EXPECT_EQ(0.25, m_pControlValue->get());
}
...
TEST_F(SuperLinkTest, Softtakeover) {
    ...
    // 0.1.
    m_pEffectSlot->onEffectMetaParameterChanged(0.7);
...
TEST_F(SuperLinkTest, HalfLinkTakeover) {
    ...
    m_pEffectSlot->onEffectMetaParameterChanged(newParam);
    EXPECT_EQ(1.0, m_pControlValue->get());
