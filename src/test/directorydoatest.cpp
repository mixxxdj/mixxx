...
TEST_F(DirectoryDAOTest, relocateDirTest) {
    ...
    TrackPointer pTrackA(TrackInfoObject::newTemporaryForFile(testdir + "/a"));
    trackDAO.addTracksAdd(pTrackA.data(), false);
    TrackPointer pTrackB(TrackInfoObject::newTemporaryForFile(testdir + "/b"));
    trackDAO.addTracksAdd(pTrackB.data(), false);
    TrackPointer pTrackC(TrackInfoObject::newTemporaryForFile(test2 + "/c"));
    trackDAO.addTracksAdd(pTrackC.data(), false);
    TrackPointer pTrackD(TrackInfoObject::newTemporaryForFile(test2 + "/d"));
    trackDAO.addTracksAdd(pTrackD.data(), false);
