...
// =============================================================================
// BNG-13: Buffer-window invariant regression tests.
//
...
// the heap-corruption crash fixed in 87e48497c1.
//
...
// BNG-13 #1 — direct invariant test (THE test that fails on pre-87e48497c1).
//
...
// BNG-13 #2 — sanity baseline: framePosition still inside buffer must NOT
...
// BNG-13 #3 — degenerate case: empty buffer window.  Both pointers should
...
// BNG-13 #4 — end-to-end high-speed grain-outrun stress.
//
...
TEST_F(EngineBufferScaleBungeeBufferWindowTest,
    ...
    for (double tempo : kTempoRatios) {
        ...
        for (int iter = 0; iter < 64; ++iter) {
            ...
            // the heap overflow once it was added in 87e48497c1.
