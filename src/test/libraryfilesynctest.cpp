...
class TempFileSystem {
  public:
    ...
    void advanceFileLastModified() const {
        ...
        EXPECT_TRUE(oldLastModified.isValid());
        ...
        do {
            ...
            EXPECT_TRUE(file.resize(fileSize + 1));
            EXPECT_TRUE(file.flush());
            EXPECT_TRUE(file.resize(fileSize));
            file.close();
            EXPECT_EQ(newLastModified, oldLastModified);
            newLastModified = fileLastModified();
            EXPECT_TRUE(newLastModified.isValid());
            EXPECT_GE(newLastModified, oldLastModified);
        ...
        EXPECT_GT(newLastModified, oldLastModified);
    }
