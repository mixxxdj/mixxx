...
void sleepAfterFileLastModifiedUpdated() {
    ...
    //
    // The duration has been increased from 1 ms to 5 ms after
    // spurious test failures on CI where the file modification
    // times generated by the OS are sometimes slightly behind the
    // time stamps generated by QtDateTime::currentDateTime().
    QThread::msleep(5);
}
