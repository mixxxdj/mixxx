...
class TrackCollectionTest : public TrackCollection {
  public:
#ifdef __SQLITE3__
    static int likeCompareLatinLowTest(QString* pattern, QString* string,
                                       const QChar esc) {
        return TrackCollection::likeCompareLatinLow(pattern, string, esc);
    }
#endif  // __SQLITE3__
};
...
TEST_F(SqliteLikeTest, PatternTest) {
    ...
    esc = '\0';
    EXPECT_TRUE(TrackCollectionTest::likeCompareLatinLowTest(&pattern, &string,
                                                             esc));
    ...
    esc = '\0';
    EXPECT_FALSE(TrackCollectionTest::likeCompareLatinLowTest(&pattern, &string,
                                                              esc));
}
#endif  // __SQLITE3__
