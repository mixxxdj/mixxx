...
TEST_F(EngineSyncTest, ExplicitMasterPersists) {
    ...
    auto pBeats1 = std::make_shared<mixxx::Beats>(m_pTrack1.get());
    pBeats1->setGrid(120);
    m_pTrack1->setBeats(pBeats1);
    auto pBeats2 = std::make_shared<mixxx::Beats>(m_pTrack2.get());
    pBeats2->setGrid(124);
...
TEST_F(EngineSyncTest, SetMasterWhilePlaying) {
    ...
    pBeats2->setGrid(124);
    m_pTrack2->setBeats(pBeats2);
    auto pBeats3 = std::make_shared<mixxx::Beats>(m_pTrack3.get());
    pBeats3->setGrid(128);
...
TEST_F(EngineSyncTest, DisableInternalMasterWhilePlaying) {
    ...
    m_pTrack1->setBeats(pBeats1);
    ControlObject::getControl(ConfigKey(m_sGroup1, "play"))->set(1.0);
    auto pBeats2 = std::make_shared<mixxx::Beats>(m_pTrack1.get());
    pBeats2->setGrid(80);
    m_pTrack2->setBeats(pBeats2);
    ControlObject::getControl(ConfigKey(m_sGroup2, "play"))->set(1.0);
    ProcessBuffer();
...
TEST_F(EngineSyncTest, FileBpmChangesDontAffectMaster) {
    ...
    pBeats1 = std::make_shared<mixxx::Beats>(m_pTrack1.get());
    pBeats1->setGrid(160);
    m_pTrack1->setBeats(pBeats1);
    EXPECT_FLOAT_EQ(
            100.0, ControlObject::get(ConfigKey(m_sInternalClockGroup, "bpm")));
