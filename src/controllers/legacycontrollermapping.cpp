...
QDebug operator<<(QDebug dbg, const LegacyControllerMapping& mapping) {
    ...
    //    ", settings" << mapping.m_settings <<
    //    ", settingsLayout" << mapping.m_settingsLayout <<
#ifdef MIXXX_USE_QML
    //    ", modules=" << mapping.m_modules <<
    //    ", screens=" << mapping.m_screens <<
#endif
            //    ", scripts=" << mapping.m_scripts <<
...
QDebug operator<<(QDebug dbg, const LegacyControllerMapping::ScriptFileInfo& script) {
    return dbg << "ScriptFileInfo<"
                  ", name="
               << script.name << ", identifier=" << script.identifier << ", file=" << script.file <<
            // ", type=" << script.type <<
