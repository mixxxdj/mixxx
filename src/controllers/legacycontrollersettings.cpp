...
void AbstractLegacyControllerSetting::serialize(QDomDocument* doc, QDomElement* e) const {
    ...
    //     <description>
    //         If enabled, the track speed will accelerate faster than the
    //         physical jogwheel movement. Be aware that the absolute track
    //         position will drift relative to the jogwheel position in this
    //         mode! (exponent: 0 and coefficient: 1 = no acceleration)
    //     </description>
    // </option>
