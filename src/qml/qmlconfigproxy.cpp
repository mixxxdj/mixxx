...
PROPERTY_IMPL_GETTER(kWaveformGroup, kVisualGainAllKey, double, waveformVisualGainAll, 2);
...
PROPERTY_IMPL_GETTER(kWaveformGroup, kVisualGainLowKey, double, waveformVisualGainLow, 1);
...
PROPERTY_IMPL_GETTER(kWaveformGroup, kVisualGainMediumKey, double, waveformVisualGainMedium, 1);
...
PROPERTY_IMPL_GETTER(kWaveformGroup, kVisualGainHighKey, double, waveformVisualGainHigh, 1);
