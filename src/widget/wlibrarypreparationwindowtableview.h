...
class WLibraryPreparationWindowTableView : public QTableView, public virtual LibraryView {
    Q_OBJECT
  ...
  public:
    WLibraryPreparationWindowTableView(QWidget* parent,
            UserSettingsPointer pConfig);
    ~WLibraryPreparationWindowTableView() override;
