...
class WLibraryPreparationWindow : public QStackedWidget, public WBaseWidget {
    Q_OBJECT
  public:
    explicit WLibraryPreparationWindow(QWidget* parent);
    ...
    WPreparationWindowTrackTableView* getCurrentTrackTableView() const;
