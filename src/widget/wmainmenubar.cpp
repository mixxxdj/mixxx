...
WMainMenuBar::WMainMenuBar(QWidget* pParent, UserSettingsPointer pConfig, KeyboardShortcutsUpdater* pKbdShortcutsUpdater)
        : QMenuBar(pParent),
          m_pConfig(pConfig),
          m_pKbdShortcutsUpdater(pKbdShortcutsUpdater) {
    initialize();
