...
declare type MixxxControl<TGroup> =
    | (string & {})
...
type MixxxSamplerControl = MixxxChannelDeckSamplerControl | "SaveSamplerBank" | "LoadSamplerBank";
...
type MixxxChannelControl = MixxxChannelDeckSamplerControl | MixxxMicrophoneAuxiliaryControl | "input_configured";

type MixxxMicrophoneControl = MixxxMicrophoneAuxiliaryControl;

type MixxxAuxiliaryControl = MixxxMicrophoneAuxiliaryControl | "orientation";
