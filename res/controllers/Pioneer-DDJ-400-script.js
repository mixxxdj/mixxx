...
PioneerDDJ400.init = function() {
    ...
    engine.makeCompressedConnection("[Channel1]", "VuMeter", PioneerDDJ400.vuMeterUpdate);
    engine.makeCompressedConnection("[Channel2]", "VuMeter", PioneerDDJ400.vuMeterUpdate);
