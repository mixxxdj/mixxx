...
TraktorS3.Controller.prototype.registerOutputPackets = function() {
    ...
    // Master VuMeters
    this.masterVuMeter["VuMeterL"].connection = engine.makeCompressedConnection("[Master]", "VuMeterL", TraktorS3.bind(TraktorS3.Controller.prototype.masterVuMeterHandler, this));
    this.masterVuMeter["VuMeterR"].connection = engine.makeCompressedConnection("[Master]", "VuMeterR", TraktorS3.bind(TraktorS3.Controller.prototype.masterVuMeterHandler, this));
