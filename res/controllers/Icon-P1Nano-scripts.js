...
(function(P1Nano) {
    ...
    class VuMeter extends components.Component {
        ...
        output(value) {
            ...
            // TODO: what is the 0x16, 0x14? I'm assuming it's a device ID?
    ...
    class VelocityEncoder extends components.Encoder {
        constructor(params) {
            ...
            if (this.screen === undefined || this.screen < 0 || this.screen > 7) {
                throw Error("Velocity encoders must specify a screen number between 0 and 7");
            }
            if (this.name === undefined && this.key !== undefined) {
                this.name = this.key[0].toUpperCase() + this.key.slice(1, this.key.length);
            }
