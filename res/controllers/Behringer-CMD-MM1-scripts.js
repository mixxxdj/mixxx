...
CMDMM.init = function () {
  ...
  CMDMM.VuMeterL = engine.makeCompressedConnection("[Master]","VuMeterL",function (value) {
    midi.sendShortMsg(MIDI.CC, 0x50, (value * 15) + 48);
  });
  CMDMM.VuMeterR = engine.makeCompressedConnection("[Master]","VuMeterR",function (value) {
