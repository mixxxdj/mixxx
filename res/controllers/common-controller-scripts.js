 ...
 *
 * Object.isSimpleObject({}) // true
 * Object.isSimpleObject(null) // false
 * Object.isSimpleObject(undefined) // false
 * Object.isSimpleObject(new Date) // false
 * Object.isSimpleObject(new (class {})()) // false
 * @param {any} obj Object to test
 * @returns {boolean} true if obj was created using the `{}` or `new Object()` synthax, false otherwise
 */
Object.isSimpleObject = function(obj) {
...
Object.deepMerge = function(target, source) {
    ...
    if (Array.isArray(target) && Array.isArray(source)) {
        ...
        Object.deepMerge(objTarget, objSource);
        target.length = 0;
        target.push(...Object.values(objTarget));
    } else if (Object.isSimpleObject(target) && Object.isSimpleObject(source)) {
        Object.keys(source).forEach(key => {
            if (
                Array.isArray(target[key]) && Array.isArray(source[key]) ||
                Object.isSimpleObject(target[key]) && Object.isSimpleObject(source[key])
            ) {
