...
DenonMC6000MK2.OldDeck.prototype.afterVinylModeOrJogTouchChanged = function() {
...
DenonMC6000MK2.OldDeck.prototype.touchJog = function(isJogTouched) {
    if (this.jogTouchState === isJogTouched) {
        return;
    }
