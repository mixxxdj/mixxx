...
declare namespace MixxxControls {
	...
	type ChannelNSamplerNPreviewDeckNControl =
		/**
		 * Fast rewind (REW)
		 *
		 * @groups [ChannelN], [SamplerN], [PreviewDeckN]
		 * @range binary
		 * @feedback << button
		 */
		| "back"
	...
	type ChannelNSamplerNPreviewDeckNAuxiliaryNControl =
		/**
		 * Assign channel to the center of the crossfader.
		 *
		 * @groups [ChannelN], [SamplerN], [PreviewDeckN], [AuxiliaryN]
		 */
		| "orientation_center"
	...
	type ChannelNControl =
		 ...
		 * @since New in version 2.5.0.
		 */
		"show_track_menu" | ChannelNSamplerNPreviewDeckNAuxiliaryNControl | ChannelNSamplerNPreviewDeckNControl;
	...
	type AuxiliaryNControl =
		 ...
		 * @since New in version 1.10.0.
		 */
		"orientation" | ChannelNSamplerNPreviewDeckNAuxiliaryNControl | MicrophoneNAuxiliaryNControl;
	...
	type EqualizerRack1ChannelIEffect1QuickEffectRack1ChannelIEffect1EffectRack1EffectUnitNEffectMControl =
		/**
		 * Clear the currently loaded Effect in this Effect slot from the EffectUnit.
		 *
		 * @groups [EqualizerRack1_[ChannelI]_Effect1], [QuickEffectRack1_[ChannelI]_Effect1], [EffectRack1_EffectUnitN_EffectM]
		 * @range binary
		 */
		| "clear"
	...
	type EffectRack1EffectUnitNEffectMControl =
		EqualizerRack1ChannelIEffect1QuickEffectRack1ChannelIEffect1EffectRack1EffectUnitNEffectMControl;

	type SamplerNControl = ChannelNSamplerNPreviewDeckNAuxiliaryNControl | ChannelNSamplerNPreviewDeckNControl;

	type PreviewDeckNControl = ChannelNSamplerNPreviewDeckNAuxiliaryNControl | ChannelNSamplerNPreviewDeckNControl;
	...
	type MicrophoneNControl = MicrophoneNAuxiliaryNControl;
	...
	namespace ReadOnly {
		...
		type ReadOnlyChannelNSamplerNPreviewDeckNControl =
			/**
		...
		type ReadOnlyEqualizerRack1EffectRack1QuickEffectRack1Control =
			/**
			 * The number of EffectUnits in this rack
			 *
			 * @groups [EqualizerRack1], [EffectRack1], [QuickEffectRack1]
			 * @range integer
			 * @readonly
			 */
			"num_effectunits";

		type ReadOnlyQuickEffectRack1ChannelIEqualizerRack1ChannelIEffectRack1EffectUnitNControl =
			/**
		...
		type ReadOnlyEqualizerRack1ChannelIEffect1QuickEffectRack1ChannelIEffect1EffectRack1EffectUnitNEffectMControl =
			/**
		...
		type ReadOnlyEqualizerRack1ChannelIControl =
			ReadOnlyQuickEffectRack1ChannelIEqualizerRack1ChannelIEffectRack1EffectUnitNControl;
		...
		type ReadOnlyChannelNControl =
			...
			| ReadOnlyChannelNSamplerNPreviewDeckNControl;

		type ReadOnlyPreviewDeckNControl = ReadOnlyChannelNSamplerNPreviewDeckNControl;

		type ReadOnlyEffectRack1EffectUnitNEffectMControl =
			ReadOnlyEqualizerRack1ChannelIEffect1QuickEffectRack1ChannelIEffect1EffectRack1EffectUnitNEffectMControl;

		type ReadOnlyEqualizerRack1Control = ReadOnlyEqualizerRack1EffectRack1QuickEffectRack1Control;

		type ReadOnlyEffectRack1Control = ReadOnlyEqualizerRack1EffectRack1QuickEffectRack1Control;

		type ReadOnlyQuickEffectRack1Control = ReadOnlyEqualizerRack1EffectRack1QuickEffectRack1Control;
		...
		type ReadOnlySamplerNControl = ReadOnlyChannelNSamplerNPreviewDeckNControl;
	...
	namespace Deprecated {
		...
		type DeprecatedChannelNSamplerNPreviewDeckNControl =
			/**
			 * Indicates if hotcue slot X is set, active or empty.
			 *
			 * @groups [ChannelN], [SamplerN], [PreviewDeckN]
		...
		type DeprecatedChannelNControl =
			/**
			 ...
			 */
			| "transform"
			| DeprecatedChannelNSamplerNPreviewDeckNControl;

		type DeprecatedMicrophoneNAuxiliaryNControl =
			/**
		...
		type DeprecatedEqualizerRack1EffectRack1QuickEffectRack1Control =
			/**
			 * Clear the Effect Rack
			 *
			 * @groups [EqualizerRack1], [EffectRack1], [QuickEffectRack1]
			 * @deprecated since  version 2.4.0: This control has been removed without a direct replacement. Use the effects framework instead.
			 */
			"clear";

		type DeprecatedQuickEffectRack1ChannelIEqualizerRack1ChannelIEffectRack1EffectUnitNControl =
			/**
			 * Cycle to the next EffectChain preset after the currently loaded preset.
			 *
			 * @groups [QuickEffectRack1_[ChannelI]], [EqualizerRack1_[ChannelI]], [EffectRack1_EffectUnitN]
		...
		type DeprecatedEffectRack1Control =
			 ...
			 */
			"show" | DeprecatedEqualizerRack1EffectRack1QuickEffectRack1Control;
		...
		type DeprecatedMicrophoneNControl =
			 ...
			 */
			"orientation" | DeprecatedMicrophoneNAuxiliaryNControl;

		type DeprecatedFlangerControl =
			/**
		...
		type DeprecatedAuxiliaryNControl = DeprecatedMicrophoneNAuxiliaryNControl;

		type DeprecatedEqualizerRack1ChannelIControl =
			DeprecatedQuickEffectRack1ChannelIEqualizerRack1ChannelIEffectRack1EffectUnitNControl;

		type DeprecatedPreviewDeckNControl = DeprecatedChannelNSamplerNPreviewDeckNControl;

		type DeprecatedSamplerNControl = DeprecatedChannelNSamplerNPreviewDeckNControl;

		type DeprecatedEqualizerRack1Control = DeprecatedEqualizerRack1EffectRack1QuickEffectRack1Control;

		type DeprecatedQuickEffectRack1Control = DeprecatedEqualizerRack1EffectRack1QuickEffectRack1Control;
