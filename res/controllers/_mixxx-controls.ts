 ...
 */
	...
	type EffectRack1_EffectUnitN_EffectMControls =
		/**
		 * Clear the currently loaded Effect in this Effect slot from the EffectUnit.
		 *
		 * @name clear
		 * @group [EffectRack1_EffectUnitN_EffectM]
		 * @range binary
		 */
		| "clear"
