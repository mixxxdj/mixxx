...
TraktorS2MK2.registerOutputPackets = function() {
    ...
    engine.makeCompressedConnection("[Channel1]", "VuMeter", TraktorS2MK2.onVuMeterChanged).trigger();
    engine.makeCompressedConnection("[Channel2]", "VuMeter", TraktorS2MK2.onVuMeterChanged).trigger();
