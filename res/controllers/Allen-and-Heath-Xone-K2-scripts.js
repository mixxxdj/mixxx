...
XoneK2.Deck = class extends components.Deck {
    constructor(column, deckNumber, midiChannel) {
        super([deckNumber]);
        var theDeck = this;
        ...
        var CueAndSeekButton = class extends components.Button {
            constructor(options) {
                ...
                options.outKey = options.cueName + '_enabled';
                super(options);
            }
            unshift() {
...
XoneK2.EffectUnit = class extends components.ComponentContainer {
    constructor(column, unitNumber, midiChannel, twoDeck) {
        super();
