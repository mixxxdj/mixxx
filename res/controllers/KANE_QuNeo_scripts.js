...
KANE_QuNeo.init = function (id) { // called when the device is opened & set up
  ...
  engine.connectControl("[Main]","VuMeter","KANE_QuNeo.masterVuMeter");
  //engine.softTakeover("[Main]","volume",true);
  engine.connectControl("[Main]","headVolume","KANE_QuNeo.headVol");
  ...
  engine.connectControl("[Main]","crossfader","KANE_QuNeo.crossFader");
...
KANE_QuNeo.masterVuMeter = function (value) {
    ...
    level = KANE_QuNeo.oneToFiveKnob(engine.getValue("[Main]","volume"))
