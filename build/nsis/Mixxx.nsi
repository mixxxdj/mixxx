...
Section "Uninstall"
  ...
  Delete "$INSTDIR\controllers\Behringer-CMD-MM-1-Advanced-scripts.js"
  Delete "$INSTDIR\controllers\Behringer CMD-MM-1-Advanced.midi.xml"
  ...
  Delete "$INSTDIR\controllers\Keyboard-Default.kbd.xml"
  ...
  Delete "$INSTDIR\controllers\midi-controls-0.0.js"
  ...
  Delete "$INSTDIR\controllers\Novation Launchpad MK2.midi.xml"
  ...
  Delete "$INSTDIR\controllers\Novation-Launchpad MK2-scripts.js"
  ...
  Delete "$INSTDIR\controllers\Pioneer DDJ-SX.midi.xml"
  Delete "$INSTDIR\controllers\Pioneer-DDJ-SX-scripts.js"
  ...
  Delete "$INSTDIR\controllers\Vestax Typhoon Enhanced.midi.xml"
