  ...
  <body>
    ...
    <div class="rowOfBoxes features">
        <div class="fullWidth noBorderOnLeft">   
			...
			<p><b>Developers</b> working on Mixxx collaborate with each other via the <a href="http://lists.sourceforge.net/lists/listinfo/mixxx-devel">mixxx-devel</a> mailing list and our IRC channel (#mixxx on Freenode). To send an email to the list, you must <a href="http://lists.sourceforge.net/lists/listinfo/mixxx-devel">subscribe first</a>. The list is low traffic.</p>
			<p>If you're a <b>DJ hardware manufacturer</b> and would like your product to work with Mixxx, please contact our Project Manager, <a href="http://www.hep.ucl.ac.uk/~adamd">Adam Davison</a>. We accept donations of DJ equipment which we use to improve both specific and general hardware support in Mixxx.</p>	
			
			<p><b>For other inquiries</b>, please contact <a href="http://www.hep.ucl.ac.uk/~adamd">Adam Davison</a>.</p>
			   
			<h2>Credits</h2>
			<p>In 2001, Mixxx was started by <a href="http://www.nbi.dk/~kenand/">Ken</a> and <a href="http://haste.dk/tue/">Tue</a> Haste Andersen. Today, development is done by an open source development team from around the world, led by Adam Davison (Project Manager) and Albert Santoni (Lead Developer):
    <p class="credits"><b>Mixxx 1.8.0 Development Team</b></p>
<p class="credits">
...
<p class="credits"><b>Past Developers</b></p>
<p class="credits">
<a href="http://haste.dk/tue/">Tue Haste Andersen</a><br>
...
Pavol Rusnak<br>
		...
		<p align="center">Mixxx also depends on a number of software libraries. Without these, Mixxx would not be possible, especially as a cross-platform application. Big thanks to <a href="http://qt.nokia.com">Qt</a>, <a href="http://www.portaudio.com">PortAudio</a>, and <a href="http://www.cs.cmu.edu/~music/portmusic/">PortMidi</a> for being fantastic.
		<br>
		<br><a href="images/splash_4.png">"Superstar DJs"</a> splash image uses source material licensed under
		 Creative Commons Attribution 3.0 Unported from Google Picasa users 
		 ...
		 <br>
		 <br>Lastly, we'd like to thank the many musicians and DJs that have helped in designing Mixxx.
		 </p>
    		</div>
    </div>
    </div>
