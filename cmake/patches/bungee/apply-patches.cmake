...
# ExternalProject_Add fallback (BNG-21).  Invoked by CMake from
...
#   MIXXX_BUNGEE_PATCH_DIR        — directory holding Mixxx-specific Bungee
#                                   patches (cmake/patches/bungee/).
#   MIXXX_BUNGEE_OVERLAY_DIR      — directory holding the vcpkg overlay port
#                                   patches (cmake/vcpkg-overlay-ports/bungee/).
#                                   Reused verbatim so there is exactly one
#                                   copy of each patch in the tree.
...
if(NOT DEFINED MIXXX_BUNGEE_OVERLAY_DIR OR MIXXX_BUNGEE_OVERLAY_DIR STREQUAL "")
  message(
    FATAL_ERROR
    "apply-patches.cmake: MIXXX_BUNGEE_OVERLAY_DIR is required"
  )
endif()

# Patch ordering matches docs/plans/bungee-dependency-integration step 5
# of BNG-21:
#   1. cmake-use-vcpkg-deps-and-install-layout — installs CMake package
#   2. pffft-include-path                     — local include fix
#   3. assert-win32-compat                    — MSVC-only
#   4. resample-msvc-noinline                 — MSVC-only
#   5. lower-cmake-minimum                    — Mixxx-only, last so it
#                                                anchors on the patched tree
set(
  _patches
  "${MIXXX_BUNGEE_OVERLAY_DIR}/cmake-use-vcpkg-deps-and-install-layout.patch"
  "${MIXXX_BUNGEE_OVERLAY_DIR}/pffft-include-path.patch"
)
if(MIXXX_BUNGEE_APPLY_MSVC_PATCHES)
  list(
    APPEND
    _patches
    "${MIXXX_BUNGEE_OVERLAY_DIR}/assert-win32-compat.patch"
    "${MIXXX_BUNGEE_OVERLAY_DIR}/resample-msvc-noinline.patch"
  )
endif()
