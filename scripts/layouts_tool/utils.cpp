...
namespace utils {
    ...
    int keysymToUnicode(KeySym keysym) {
        int keysymTableSize = sizeof(keySymTable) / sizeof(KeysymUnicodePair) - 1;
        for (int i = 0; i < keysymTableSize; i++) {
            KeysymUnicodePair &keysymUnicodePair = keySymTable[i];
            if (keysymUnicodePair.keysym == keysym) {
                return keysymUnicodePair.unicodePosition;
            }
        }
        return 0;
    }
